...
public class PedirDatos_Statica {
    ...
    // ------------------ Leer String -----------------------
    public static String Leer_String(String Pregunta) throws IOException {
    ...
    public static String Leer_String_Sin_Numeros(String Pregunta) throws IOException {
    ...
    //--------------- Leer Double --------------------------
    public static Double Numero_Double(String Pregunta) throws IOException {
    ...
    //-------------------- Leer Numero ---------------------------
    public static int Numero_Int(String Pregunta) throws IOException {
