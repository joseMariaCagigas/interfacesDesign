        ...
        if (ae.getSource() == boton5) {
            ...
            try {
                if ((input1.getText().length() == 0) || (input2.getText().length() == 0)) {
                    caja.Cuadro_Warning("Error", "Falta Algún Operando");
                } else {
                    ...
                    if (ae.getSource() == boton4) {
                        ...
                        if ((operando1 == 0) || (operando2 == 0)) {
                            caja.Cuadro_Warning("Error", "Como Quieres Dividir Con Un 0 De Operando ¬¬");
                        } else {
                ...
                caja.Cuadro_Warning("Error", "No Me Metas Letras ¬¬");
                input3.setText(null);
            }
        }
    }
